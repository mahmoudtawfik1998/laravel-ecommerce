...
<body class="animsition">
            ...
            <ul class="main-menu-m">
                <li>
                    ...
                    <ul class="sub-menu-m">
                        ...
                        <li><a href="home-02.html">Dashboardpage 2</a></li>
                        <li><a href="home-03.html">Dashboardpage 3</a></li>
                    </ul>
                ...
                <li>
                    <a href="{{ asset('template/product.html') }}">Shop</a>
                </li>

                <li>
                    <a href="{{ asset('template/shoping-cart.html') }}" class="label1 rs1"
                        data-label1="hot">Features</a>
                </li>
    ...
    <section class="section-slide">
        <div class="wrap-slick1">
            <div class="slick1">
                <div class="item-slick1" style="background-image: url({{ asset('template/images/slide-01.jpg') }});">
                ...
                <div class="item-slick1" style="background-image: url({{ asset('template/images/slide-02.jpg') }});">
                    <div class="container h-full">
                        <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
                ...
                <div class="item-slick1" style="background-image: url({{ asset('template/images/slide-03.jpg') }});">
                    <div class="container h-full">
                        <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
                    ...
                    <div class="block1 wrap-pic-w">
                        ...
                        <a href="{{ asset('template/product.html') }}"
                            class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
                            <div class="block1-txt-child1 flex-col-l">
                                <span class="block1-name ltext-102 trans-04 p-b-8">
                                    Men
                ...
                <div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
                    <!-- Block1 -->
                    <div class="block1 wrap-pic-w">
                        <img src="{{ asset('template/images/banner-03.jpg') }}" alt="IMG-BANNER">
